                    ...
                    <div class="featured-grid">
                        <a href="{{ route('posts.show', $featuredPost) }}" class="featured-main">
                            <div class="news-thumbnail">
                                ...
                                @endif
                                <div
                                    class="category-badge {{ $featuredPost->category ? strtolower($featuredPost->category->name) : 'music' }}">
                                ...
                                <div class="news-meta">
                                    <div class="author-info">
                                        <div class="author-avatar">
                                            {{ substr($featuredPost->user->name ?? 'Unknown Author', 0, 1) }}
                                        </div>
                                ...
                                <a href="{{ route('posts.show', $sidePost) }}" class="featured-side-item">
                                    <div class="news-thumbnail">
                                        @if ($sidePost->thumbnail)
                                            <img src="{{ asset('storage/' . $sidePost->thumbnail) }}"
                                                alt="{{ $sidePost->title }}">
                                        @else
                                            <div class="news-thumbnail-placeholder">🎵</div>
                                        @endif
                ...
                <div class="section-controls">
                    <div class="search-container">
                        <div class="search-box">
                            ...
                            <input type="text" placeholder="Search music articles, artists, genres..."
                                id="searchInput">
                        ...
                        @foreach ($displayPosts as $post)
                            <a href="{{ route('posts.show', $post) }}" class="news-card"
                                ...
                                <div class="news-thumbnail">
                                    ...
                                    @endif
                                    <div
                                        class="category-badge {{ $post->category ? strtolower($post->category->name) : 'music' }}">
                                ...
                                <div class="news-content">
                                    <div class="news-meta">
                                        <div class="author-info">
                                            <div class="author-avatar">
                                                {{ substr($post->user->name?? 'Unknown Author' , 0, 1) }}
                                            </div>
                                            <span class="author-name">{{ $post
                                        ->user->name ?? 'Unknown Author' }}</span>
                                        </div>
                                        <div class="date-text">
                                    ...
                                    <tr data-title="{{ strtolower($post->title) }}"
                                        ...
                                        <td>
                                            <div style="display: flex; align-items: center; gap: 12px;">
                                                @if ($post->thumbnail)
                                                    <img src="{{ asset('storage/' . $post->thumbnail) }}"
                                                        alt="{{ $post->title }}" class="table-thumbnail">
                                                @else
                                                    <div
                                                        style="width: 60px; height: 40px; background: var(--gradient-primary); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: white; font-size: 20px;">
                                                        🎵
                                                    </div>
                                                @endif
                                                <div>
                                        ...
                                        <td>
                                            <span
                                                class="table-category {{ $post->category ? strtolower($post->category->name) : 'music' }}"
                                        ...
                                        <td>
                                            <span
                                                style="font-weight: 700; color: var(--primary);">{{ $post->views ?? 0 }}</span>
                                        </td>
                                        <td>
                                            @if ($post->views > 100)
                                                <span
                                                    style="background: var(--gradient-secondary); color: white; padding: 4px 8px; border-radius: 12px; font-size: 11px; font-weight: 700;">
                                                    TRENDING
                                                </span>
                                            @else
                                                <span
                                                    style="background: var(--gray-light); color: var(--gray-dark); padding: 4px 8px; border-radius: 12px; font-size: 11px; font-weight: 700;">
                                                    NORMAL
                                                </span>
                                            @endif
                                        </td>
