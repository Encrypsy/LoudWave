...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1 class="page-title">Create New Tag</h1>
            <p class="page-subtitle">Organize your music content with custom tags</p>
        </div>
        ...
        <div class="form-container">
            ...
            <div class="form-content">
                <form action="{{ route('tag.store') }}" method="POST" id="tagForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter tag name (e.g., Rock, Pop, Electronic...)" required maxlength="30">
                    ...
                    <div class="form-actions">
                        <a href="{{ route('tag') }}" class="btn btn-secondary">
