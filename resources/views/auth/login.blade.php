            ...
            <div class="login-form-container">
                ...
                <form id="loginForm" action="/login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="your.email@loudwave.com" required>
                ...
                <p class="signup-text">
                    New to LoudWave? <a href="/register">Create an account</a>
                </p>
            </div>
        </div>
    </div>
